...
def create_lmdb_for_gopro():
    folder_path = './datasets/Sim/train/blur_crops'
    lmdb_path = './datasets/Sim/train/blur_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/Sim/train/sharp_crops'
    lmdb_path = './datasets/Sim/train/sharp_crops.lmdb'
...
def create_lmdb_for_val():
    folder_path = './datasets/Sim/test/input'
    lmdb_path = './datasets/Sim/test/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/Sim/test/target'
    lmdb_path = './datasets/Sim/test/target.lmdb'
